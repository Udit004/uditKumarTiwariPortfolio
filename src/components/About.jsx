  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl w-full mx-auto">
        <div className="backdrop-blur-xl bg-white/5 border border-white/10 rounded-3xl p-6 sm:p-8 md:p-12 shadow-2xl">
          {/* Section Header */}
          ...
          <div className="grid lg:grid-cols-2 gap-8 md:gap-12 lg:gap-16 items-start mb-16">
            ...
            <div className="flex justify-center lg:justify-start order-1 lg:order-1">
              <div className="relative group w-full max-w-xs sm:max-w-sm lg:max-w-md">
                ...
                <div className="absolute top-0 right-0 w-14 h-14 sm:w-16 sm:h-16 bg-gradient-to-br from-slate-700 to-slate-800 rounded-full flex items-center justify-center shadow-xl border border-slate-500/30">
                ...
                <div className="absolute bottom-0 left-0 w-12 h-12 sm:w-14 sm:h-14 bg-gradient-to-br from-slate-700 to-slate-800 rounded-full flex items-center justify-center shadow-xl border border-slate-500/30">
